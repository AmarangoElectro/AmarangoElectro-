...
const files = [
  "AmarangoElectro-V16-V4.15.1-Premium-App-UX-Closure-Standalone-Android.html",
...
const result = { gate: "V4.15.1", mode: "premium_app_ux_closure_read_only", scannedFiles: files, counts, passed: Object.values(counts).every((count) => count === 0) };
