// ============================================================
//  AMARA 🐝 — Asistente de ventas de AmarangoElectro (v2)
//  Función serverless de Netlify. La clave de Google vive ACÁ,
//  escondida en el servidor. NUNCA se ve en la tienda pública.
//
//  Esta versión ANOTA el error real en los logs de Netlify,
//  así si algo falla sabemos exactamente qué pasó.
// ============================================================
...
exports.handler = async function (event) {
  ...
  try {
    ...
    try {
      ...
      console.log("AMARA ERROR: respuesta rara de Google: " + JSON.stringify(data));
      texto =
