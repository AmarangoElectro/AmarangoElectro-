...
export const retailCategories: readonly RetailCategoryEntry[] = [
  ...
  { id: "deporte-movilidad", title: "Deporte y movilidad", eyebrow: "MOVIMIENTO", description: "Aire libre, movilidad y opciones para disfrutar cada salida.", href: categoryHref("camping-aire-libre-mascotas", "camping-y-aire-libre"), icon: "🚲", image: sectorArt("deporte-movilidad"), mobileImage: sectorArt("deporte-movilidad"), size: "wide", ...backgroundArtwork },
