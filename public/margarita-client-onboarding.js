/* AmarangoElectro · onboarding opcional y seguro de clientes con Margarita
   ...
   - invita a registrarse con nombre + WhatsApp y permite postergar
   - regalo asegurado en la primera compra, sin monto mínimo
...
(function(){
  ...
  var estado={tipo:'nuevo',cliente:null,nombre:'',telefono:'',solicitoPromos:false};
...
#${INV}{position:fixed;left:50%;bottom:86px;transform:translate(-50%,14px);z-index:11800;width:min(430px,calc(100% - 22px));background:#fff;border:1px solid rgba(11,45,107,.14);border-radius:20px;padding:12px;box-shadow:0 15px 42px rgba(3,15,45,.28);font-family:inherit;opacity:0;transition:opacity .2s ease,transform .2s ease}#${INV}.on{opacity:1;transform:translate(-50%,0)}.mgi-row{display:flex;align-items:flex-start;gap:10px}.mgi-avatar{width:46px;height:46px;border-radius:50%;object-fit:cover;border:1.5px solid #0B2D6B;background:#fff;flex:0 0 auto}.mgi-copy{min-width:0;flex:1}.mgi-title{font-size:.76rem;font-weight:950;color:#0B2D6B;line-height:1.25}.mgi-gift{display:inline-flex;align-items:center;gap:5px;margin-top:5px;background:linear-gradient(135deg,#FFF3E6,#FFF8D8);border:1px solid #FFD09B;border-radius:999px;padding:5px 8px;color:#B45309;font-size:.62rem;font-weight:950;line-height:1}.mgi-text{font-size:.66rem;color:#566274;line-height:1.4;margin-top:6px}.mgi-actions{display:grid;grid-template-columns:1.15fr .85fr;gap:7px;margin-top:10px}.mgi-primary,.mgi-later{border-radius:11px;padding:9px 8px;font:900 .66rem/1.1 inherit}.mgi-primary{border:0;background:linear-gradient(135deg,#FF7A00,#ff9838);color:#fff;box-shadow:0 5px 14px rgba(255,122,0,.22)}.mgi-later{background:#fff;color:#526174;border:1.5px solid #dbe3ee}.mgi-legal{font-size:.53rem;color:#88919e;line-height:1.35;text-align:center;margin-top:7px}
#${OVER}{position:fixed;inset:0;z-index:22000;background:linear-gradient(160deg,rgba(2,12,46,.92),rgba(11,45,107,.86));backdrop-filter:blur(9px);display:flex;align-items:center;justify-content:center;padding:18px;overflow:auto}#${OVER}[hidden]{display:none!important}.mgoc{position:relative;width:min(420px,96vw);background:#fff;border-radius:25px;padding:18px;box-shadow:0 26px 80px rgba(0,0,0,.4);font-family:inherit}.mgo-x{position:absolute;top:11px;right:11px;width:34px;height:34px;border-radius:10px;border:1px solid #dce3ed;background:#fff;color:#465469;font-size:1.05rem}.mgoh{display:flex;gap:11px;align-items:center;margin:1px 42px 12px 0}.mgoa{width:58px;height:58px;border-radius:50%;object-fit:cover;border:2px solid #0B2D6B;background:#fff}.mgot{font-size:1.02rem;font-weight:950;color:#0B2D6B}.mgos{font-size:.67rem;color:#667085;margin-top:3px}.mgogift{background:linear-gradient(135deg,#FFF3E6,#FFF8D8);border:1.5px solid #FFD09B;border-radius:14px;padding:10px 11px;margin:8px 0 11px;color:#9A4D00}.mgogift b{display:block;font-size:.77rem;font-weight:950;color:#C45F00}.mgogift span{display:block;font-size:.61rem;line-height:1.4;margin-top:3px;color:#7C5B35}.mgob{background:#f4f7fb;border:1px solid #e2e8f1;border-radius:16px 16px 16px 5px;padding:11px 12px;color:#263244;font-size:.76rem;font-weight:650;line-height:1.45;margin:8px 0 12px}.mgostep{display:none}.mgostep.on{display:block}.mgof{margin:9px 0}.mgof label{display:block;font-size:.63rem;font-weight:900;color:#475569;margin:0 0 5px 2px}.mgof input{width:100%;box-sizing:border-box;border:1.5px solid #d8e0eb;border-radius:12px;padding:12px;font:750 .79rem inherit;color:#172033;outline:none}.mgof input:focus{border-color:#FF7A00;box-shadow:0 0 0 3px rgba(255,122,0,.09)}.mgo-consent{display:flex;align-items:flex-start;gap:8px;background:#F8FAFC;border:1px solid #E2E8F0;border-radius:12px;padding:9px 10px;margin-top:9px}.mgo-consent input{width:17px;height:17px;margin-top:1px;accent-color:#0B2D6B;flex:0 0 auto}.mgo-consent span{font-size:.61rem;line-height:1.4;color:#475569}.mgo-consent b{color:#0B2D6B}.mgoact{display:grid;gap:8px;margin-top:12px}.mgop,.mgosec{width:100%;border-radius:13px;padding:12px;font:900 .77rem inherit}.mgop{border:0;background:#0B2D6B;color:#fff}.mgosec{background:#fff;color:#0B2D6B;border:1.5px solid #d9e2ef}.mgonote{font-size:.56rem;color:#7b8492;line-height:1.4;text-align:center;margin-top:9px}.mgoerr{display:none;background:#fff2f2;border:1px solid #ffd5d5;color:#9b1c1c;border-radius:10px;padding:8px 10px;font-size:.64rem;font-weight:800;margin-top:8px}.mgoerr.on{display:block}
#${GREET}{position:fixed;z-index:9998;max-width:235px;background:#fff;color:#0B2D6B;border:1px solid rgba(11,45,107,.16);border-radius:15px 15px 5px 15px;padding:9px 11px;box-shadow:0 9px 25px rgba(3,15,45,.23);font:800 .71rem/1.35 system-ui;opacity:0;transform:translateY(8px) scale(.98);transition:.2s;pointer-events:none}#${GREET}.on{opacity:1;transform:none;pointer-events:auto}#${GREET} b{color:#FF7A00}#${GREET}:after{content:"";position:absolute;right:-7px;bottom:9px;width:13px;height:13px;background:#fff;border-right:1px solid rgba(11,45,107,.12);border-bottom:1px solid rgba(11,45,107,.12);transform:rotate(-45deg)}
...
`;
  ...
  function mostrarInvitacion(){
    ...
    i.innerHTML='<div class="mgi-row"><img class="mgi-avatar" src="'+AVATAR+'" alt="Margarita"><div class="mgi-copy"><div class="mgi-title">¡Hola! Soy Margarita 🐝</div><div class="mgi-gift">🎁 REGALO en tu primera compra</div><div class="mgi-text">Si querés, te registro en menos de 20 segundos. <b>Sin compra mínima:</b> siempre recibís un obsequio, elegido por AmarangoElectro según el producto que compres.</div></div></div><div class="mgi-actions"><button id="mgi-register" class="mgi-primary" type="button">🎁 Quiero mi regalo</button><button id="mgi-later" class="mgi-later" type="button">Ahora no, quiero mirar</button></div><div class="mgi-legal">Registrarte es opcional y no bloquea la tienda. Las comunicaciones comerciales por WhatsApp se autorizan por separado.</div>';
  ...
  function crear(){
    ...
    '<div id="mgostep1" class="mgostep on"><div class="mgogift"><b>🎁 Tu primera compra viene con regalo</b><span>No hay monto mínimo. El obsequio se define según el producto que compres, pero el regalo está incluido.</span></div><div class="mgob">Si querés que te recuerde cuando vuelvas, dejame solamente tu nombre y WhatsApp. Después podés seguir mirando la tienda normalmente.</div><div class="mgof"><label>Nombre y apellido</label><input id="mgonombre" autocomplete="name" placeholder="Ej: Maximiliano Ezequiel Cardozo"></div><div class="mgof"><label>WhatsApp</label><input id="mgotel" inputmode="tel" autocomplete="tel" placeholder="Ej: 11 5555-5555"></div><label class="mgo-consent"><input id="mgopromos" type="checkbox"><span><b>Quiero recibir ofertas y novedades por WhatsApp.</b><br>Es opcional. Podés pedir la baja cuando quieras.</span></label><div id="mgoerr" class="mgoerr"></div><div class="mgoact"><button id="mgonext" class="mgop" type="button">Continuar</button><button id="mgoexisting" class="mgosec" type="button">Ya soy cliente</button><button id="mgolater" class="mgosec" type="button">Ahora no, seguir mirando</button></div><div class="mgonote">El registro usa nombre y WhatsApp para reconocerte. El regalo no depende de aceptar promociones.</div></div>'+
    '<div id="mgostep2" class="mgostep"><div id="mgobubble2" class="mgob"></div><div class="mgof"><label>¿Cómo querés que te llame Margarita?</label><input id="mgoapodo" autocomplete="nickname" placeholder="Ej: Maxi"></div><div id="mgoerr2" class="mgoerr"></div><div class="mgoact"><button id="mgosave" class="mgop" type="button">🎁 Guardar y reservar mi regalo</button><button id="mgoback" class="mgosec" type="button">Atrás</button></div></div>'+
    '<div id="mgostep3" class="mgostep"><div class="mgob">Si ya te registraste antes, escribí el celular que usaste y recupero tu nombre.</div><div class="mgof"><label>WhatsApp registrado</label><input id="mgofindtel" inputmode="tel" autocomplete="tel" placeholder="Ej: 11 5555-5555"></div><div id="mgoerr3" class="mgoerr"></div><div class="mgoact"><button id="mgofind" class="mgop" type="button">Buscar mi registro</button><button id="mgofindback" class="mgosec" type="button">Soy cliente nuevo</button></div></div></div>';
  ...
  function abrir(){
    ...
    estado={tipo:'nuevo',cliente:null,nombre:'',telefono:'',solicitoPromos:false};
