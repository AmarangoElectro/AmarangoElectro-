...
const MODULOS_AUXILIARES = [
  ...
  "./margarita-ui-approved-guard.js?v=20260824-2",
  "./margarita-visual-tune.js?v=20260824-2",
  ...
  "./margarita-client-role-guard.js?v=20260824-2",
  "./clientes-crm-export.js?v=20260824-4",
  "./admin-clientes-fidelidad.js?v=20260824-2",
  "./cliente-compartir-productos.js?v=20260824-2",
  "./cliente-compartir-deeplink.js?v=20260824-3",
  "./cliente-ui-comercial.js?v=20260824-4",
