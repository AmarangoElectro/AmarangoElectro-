...
#margarita-teaser span{display:block;margin-top:2px;color:#0B2D6B;font-weight:700;}\
...
@media(max-width:360px){#margarita-teaser{max-width:190px;font-size:.69rem;padding:8px 10px;}}\
';
  ...
  function ubicar(){
    ...
    var ancho=b.offsetWidth||200;
    var alto=b.offsetHeight||52;
  ...
  function crear(){
    ...
    b.innerHTML='<b>¡Bienvenido a AmarangoElectro! 🐝</b><span>Estoy acá para ayudarte a recorrer la tienda.</span>';
