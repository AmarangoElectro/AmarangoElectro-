/* AmarangoElectro · ajustes UX Margarita + voz
   ...
   - Separa el microfono de controles de limpiar y hace evidente el estado "Escuchando".
*/
(function(){
  'use strict';
  const VERSION='mg-ux-voz-20260825-2';
  ...
  function estilos(){
    ...
    const s=document.createElement('style');s.id='mg-ux-voz-style';s.textContent=`
      @keyframes aeVoicePulse{0%,100%{box-shadow:0 0 0 0 rgba(255,122,0,.15),0 0 0 0 rgba(11,45,107,.08)}50%{box-shadow:0 0 0 7px rgba(255,122,0,.20),0 0 22px 6px rgba(11,45,107,.18)}}
      ...
      .mg-voice-btn{border:1px solid rgba(11,45,107,.12)!important;background:#fff!important;color:#0B2D6B!important;width:38px!important;height:38px!important;min-width:38px!important;min-height:38px!important;border-radius:999px!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:6px!important;font:800 .69rem/1 system-ui,-apple-system,Segoe UI,sans-serif!important;box-shadow:0 2px 8px rgba(11,45,107,.08)!important;padding:0!important;cursor:pointer!important;flex:0 0 38px!important;transition:width .2s ease,background .2s ease,box-shadow .2s ease!important;overflow:hidden!important;white-space:nowrap!important}
      .mg-voice-btn.on{width:112px!important;min-width:112px!important;flex-basis:112px!important;background:#fff3e8!important;color:#b64d00!important;border-color:rgba(255,122,0,.45)!important;animation:aeVoicePulse 1s ease-in-out infinite!important}
      .mg-voice-btn .ae-voice-label{display:none}.mg-voice-btn.on .ae-voice-label{display:inline}
      .ae-voice-wrap{position:relative!important}
      .ae-voice-search{position:absolute!important;right:48px!important;top:50%!important;transform:translateY(-50%)!important;width:38px!important;height:38px!important;border:1px solid rgba(11,45,107,.12)!important;border-radius:999px!important;background:#fff!important;color:#0B2D6B!important;font:800 .68rem/1 system-ui,-apple-system,Segoe UI,sans-serif!important;display:flex!important;align-items:center!important;justify-content:center!important;gap:6px!important;z-index:4!important;padding:0!important;box-shadow:0 2px 8px rgba(11,45,107,.10)!important;transition:width .2s ease,background .2s ease,box-shadow .2s ease!important;overflow:hidden!important;white-space:nowrap!important}
      .ae-voice-search.on{width:118px!important;background:#fff3e8!important;color:#b64d00!important;border-color:rgba(255,122,0,.48)!important;animation:aeVoicePulse 1s ease-in-out infinite!important}
      .ae-voice-search .ae-voice-label{display:none}.ae-voice-search.on .ae-voice-label{display:inline}
      .ae-voice-wrap input{padding-right:94px!important}
      .ae-voice-search.on+*{}
      @media(max-width:380px){.ae-voice-search{right:44px!important}.ae-voice-search.on{width:108px!important}.ae-voice-wrap input{padding-right:88px!important}}
  ...
  function setEscuchando(btn,on){
    if(!btn)return;
    btn.classList.toggle('on',!!on);
    btn.setAttribute('aria-label',on?'Escuchando por voz':'Hablar por voz');
    btn.title=on?'Escuchando…':'Hablar por voz';
  }
  ...
  function contenidoMicro(b){b.innerHTML='<span aria-hidden="true">🎙️</span><span class="ae-voice-label">Escuchando…</span>';}
  ...
  function microMargarita(){
    ...
    const b=document.createElement('button');b.type='button';b.className='mg-voice-btn';b.setAttribute('aria-label','Hablar por voz');b.title='Hablar por voz';contenidoMicro(b);
  ...
  function microBuscador(){
    ...
    candidatos.forEach(input=>{
      ...
      const b=document.createElement('button');b.type='button';b.className='ae-voice-search';b.setAttribute('aria-label','Buscar por voz');b.title='Buscar por voz';contenidoMicro(b);p.appendChild(b);
